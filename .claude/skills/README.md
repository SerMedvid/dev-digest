...
| [frontend-architecture](frontend-architecture/SKILL.md) | Frontend | Where code lives — folder structure, component decomposition, constants, business-logic placement, module boundaries |
...
| [impl-sdd](impl-sdd/SKILL.md) | Shared | **Off — do not use.** Executed an approved plan (implementation, traceability, three-axis review, bounded remediation). Superseded by `superpowers:executing-plans`; kept for reference only. See the Superpowers section of [`../../CLAUDE.md`](../../CLAUDE.md) |
| [workflow-retro](workflow-retro/SKILL.md) | Shared | Post-run retrospective on a multi-agent fan-out — tokens, launch order, critical path, duplicated work, prompt fixes. Reports to gitignored `.devdigest/workflow-retro/` |
