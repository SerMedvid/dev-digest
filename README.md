...
| `mcp/`           | `@devdigest/mcp`            | Local MCP server: reviews, findings, conventions (pnpm) | —    |
...
| L03 | ~~Intent layer~~ (shipped — see [`server/specs/intent.md`](server/specs/intent.md)) · Smart Diff |
...
| mcp (hermetic, API faked) | `mcp.yml` | no |
